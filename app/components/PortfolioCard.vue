...
<template>
  <div class="bg-white/80 dark:bg-slate-900/50 backdrop-blur-sm border border-slate-200 dark:border-slate-700 rounded-2xl p-8 hover:border-mango-orange/50 transition-all duration-300 group h-full flex flex-col">
    ...
    <!-- Tagline -->
    <p class="text-mango-orange font-medium mb-3">
      {{ tagline }}
    </p>
    ...
    <a
      ...
      :href="link"
      target="_blank"
      class="inline-flex items-center gap-2 text-mango-orange hover:text-mango-yellow transition-colors duration-200"
    >
      View Project
